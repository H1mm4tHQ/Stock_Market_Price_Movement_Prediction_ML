...
cmp = input("Give ticker name of the stock " )
cmp = cmp + '.NS'
recent_data = yf.download(cmp, period="2y",interval="1d")   #month: mo
...
def calculate_macd(data, short_window=12, long_window=26, signal_window=9):
    ...
    short_ema = data['Close'].ewm(span=short_window, adjust=False).mean()  # EMA will give more weightage to the recent price
...
if y_next==0:
    print("The movement for the next trading day may be down trend") # y_next==1 upward , y_next==0 downward.
elif y_next==1:
    print("The movement for the next trading day may be up trend")